...
from cnelsonAppDemo.cnelsonAppDemoImpl import cnelsonAppDemo
from cnelsonAppDemo.cnelsonAppDemoServer import MethodContext
...
class cnelsonAppDemoTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('cnelsonAppDemo'):
        ...
        cls.serviceImpl = cnelsonAppDemo(cls.cfg)
    ...
    # NOTE: According to Python unittest naming rules test method names should start from 'test'. # noqa
    def test_run_cnelsonAppDemo_ok(self):
        # call your implementation
        ret = self.serviceImpl.run_cnelsonAppDemo(self.ctx,
    ...
    def test_run_cnelsonAppDemo_min_len_negative(self):
        with self.assertRaisesRegex(ValueError, 'min_length parameter cannot be negative'):
            self.serviceImpl.run_cnelsonAppDemo(self.ctx,
                                              {'workspace_name': self.wsName,
                                               'assembly_input_ref': '1/fake/3',
                                               'min_length': '-10'})

    def test_run_cnelsonAppDemo_min_len_parse(self):
